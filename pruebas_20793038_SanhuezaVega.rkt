...
(define op102 (option 2 "2) cambio de PLAN" 2 1 "cambio de PLAN" "plan" "cambio" "actualizar")) ; option 2/3
...
(define f102 (flow-add-option f101 op102)) ; flow-add-option 1/3
(define f103 (flow-add-option f102 op103)) ; flow-add-option 2/3
(define f104 (flow-add-option f103 op104)) ; flow-add-option 3/3

(define cb101 (chatbot 0 "Inicial" "Bienvenido\n¿Qué te gustaría realizar?" 1 f104 f104 f104))  ; chatbot 1/3
...
; Logear y desloguear usuarios en el sistema 
; (user777 no existe y user1 no se puede loguear hasta desloguear user2)
...
; Interactuar con chatbots con system-talk-rec

(define s116 (system-talk-rec s115 "1")) ; system-talk-rec 1/3
(define s117 (system-talk-rec s116 "3")) ; system-talk-rec 2/3
(define s118 (system-talk-rec s117 "2")) ; system-talk-rec 3/3

; Intento de interaccion con chatbot sin usuario

(define s119 (system-logout s118)) ; system-logout 2/3
(define s120 (system-talk-rec s119 "3")) ; system-talk-rec 4/3

; Interactuar con chatbots con system-talk-norec

(define s121 (system-login s120 "user2")) ; system-login 5/3
(define s122 (system-talk-norec s121 "3")) ; system-talk-norec 1/3
(define s123 (system-talk-norec s122 "3")) ; system-talk-norec 1/3
(define s124 (system-talk-norec s123 "4")) ; system-talk-norec 1/3

; Intento de ir a un chatbot a partir de una opcion que no existe

(define s125 (system-talk-norec s124 "9")) ; system-talk-norec 1/3

; Ir del chatbot 4 al chatbot 2 (asumiendo portabilidad en la misma compañia = cambio de plan)

(define s126 (system-talk-norec s125 "2")) ; system-talk-norec 1/3
